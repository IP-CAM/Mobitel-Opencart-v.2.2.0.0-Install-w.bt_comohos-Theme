...
class ControllerCommonMenu extends Controller {
	public function index() {
		$this->load->language('common/menu');
			...
			$data['boss_refinesearch'] = $this->url->link('catalog/boss_refinesearch_setting', 'token=' . $this->session->data['token'], true);
...
$data['design'] = $this->url->link('design/boss_layout', 'token=' . $this->session->data['token'], true);
